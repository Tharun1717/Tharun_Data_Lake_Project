...
db_name = 'lvi3plp-stg'
table_name = 'ORION_EDW.JSON_APPOINTMENT_STG'  # ACA HAY QUE CAMBIAR A LA TABLA QUE VAYAMOS A USAR!!
...
def main2():
    ...
    date_to_process = datetime(2023, 10, 27).date()  # Change this to the desired date
